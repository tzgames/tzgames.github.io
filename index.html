...
body {background-color: #2966B8;}
h1{color:red;font-family:verdana;font-size: 60px;}
div.a {
text-align: center;
}
#troll{ color: #ADFF2F;}
#test{color: red;}
#random{font-size: 50px;color: orange;font-family: fantasy;}
#why{font-size:20px;color: #7FFF00;}
.button {
padding:10px 50px;
font-size: 24px;
text-align: center;
